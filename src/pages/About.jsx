    ...
    <div className="about-page">
      ...
      <section className="founder">
        ...
        <div className="founder-content">
          ...
          <p>
            "GlowNest Beauty was built with a passion for helping
            people feel confident in their own skin. Every product
            reflects our commitment to quality, authenticity and
            customer happiness."
          </p>
      ...
      <section className="about-cta">
        ...
        <p>
          Discover premium skincare, makeup, haircare and exclusive
          beauty offers. Start your beauty journey with GlowNest
          today.
        </p>
